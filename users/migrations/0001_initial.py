    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', models.CharField(max_length=12, validators=[core.validators.PhoneNumberValidator(10, 12), users.validators.phone_number_validator])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', models.CharField(max_length=12, validators=[core.validators.PhoneNumberValidator(10, 12), users.validators.phone_number_validator])),
                ('address', models.CharField(blank=True, max_length=100, null=True)),
                ('favorite_services', models.ManyToManyField(blank=True, related_name='+', to='services.service')),
            ],
            options={
                'abstract': False,
            },
